...
class ExoticOptions(VanillaProducts):
    ...
    def __init__(self, s: pd.DataFrame, style: str, k: float, maturity: float, trajectories: int, exotic_style: str,
        ...
        """
            @param exotic_style: style of the exotic option ("a", asian option; "do", down-and-out option;
                                 "di", down-and-in option; "uo", up-and-out option; "ui", up-and-in option)
